...
我们很高兴宣布：适用于 1.21.1 NeoForge 版本的 IndustrialCraft 2 **正式版** 终于发布了！

这个版本基于官方 1.19.2 进行了迁移和重构，缺少的部分由 1.12.2 迁移来。约 50% 代码由人工迁移，剩余 50% 由 AI 辅助迁移完成。

我们在迁移过程中修复了许多旧版本的 bug，并且遵循原意，*不会* 引入新的功能或改变现有功能的行为。
