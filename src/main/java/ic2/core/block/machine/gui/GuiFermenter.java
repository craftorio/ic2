...
public class GuiFermenter extends Ic2Gui<ContainerFermenter>
{
	...
	public GuiFermenter(ContainerFermenter container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(new LinkedGauge(this, 42, 41, container.base, "heat", Gauge.GaugeStyle.HeatFermenter).withTooltip(() -> Component.translatable("ic2.Fermenter.gui.info.conversion").getString() + " " + (int) (container.base.getGuiValue("heat") * 100.0) + "%"));
