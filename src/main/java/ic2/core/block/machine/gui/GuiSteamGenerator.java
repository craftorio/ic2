...
public class GuiSteamGenerator extends Ic2Gui<ContainerSteamGenerator>
{
	...
	public GuiSteamGenerator(ContainerSteamGenerator container, Inventory playerInventory, Component title)
	{
		...
		this.addElement(new LinkedGauge(this, 155, 61, container.base, "calcification", Gauge.GaugeStyle.CalcificationSteamGenerator).withTooltip(() -> Component.translatable("ic2.SteamGenerator.gui.calcification", GuiSteamGenerator.this.menu.base.getCalcification()).getString() + "%"));
